...
pdf("gpFit.pdf", width = 8, height = 6)
...
axis(1, 1998:2018)
abline(h = 50, lty = 2)
legend("topleft", c("Median", "50%", "95%", "99%"), col = c("black", "gray45", "gray65", "gray85"), lwd = 2, bty="n", cex=0.7)
...
curve(ETI1_d_f(x), 1, 6, ylim=c(0,1), add=TRUE, lwd = 2)
title("ETI([1998; 2018])", font.main=1)
legend("topleft", c("Median", "50%", "95%"), col = c("black", "gray65", "gray80"), lwd = 2, bty="n", cex=0.7, lty=c(2,1,1))

plot(0, 0, type="n", xlim=c(1,3), ylim=c(0,2), xlab="ETI", ylab="Posterior density", xaxt="n")
axis(1, seq(1, 3, 0.25), cex.axis = 0.8)
...
curve(ETI2_d_f(x), 1, 3, ylim=c(0,2), add=TRUE, lwd = 2)
