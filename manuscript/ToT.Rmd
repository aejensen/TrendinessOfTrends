...
\begin{align*}
  \widehat{\Theta}_{-i}^\mathcal{M} = \argsup_{\Theta} N\left(\mathbf{Y}_{-i} \mid \mu_\beta^\mathcal{M}(\mathbf{t}_{-i}), C_\theta^\mathcal{M}(\mathbf{t}_{-i}, \mathbf{t}_{-i}) + \sigma^2 I\right)
\end{align*}
