...
\begin{align}
  \text{ETI}(\mathcal{I}) = \E\left[\#\left\{s : s \in \mathcal{I}, df(s) = 0\right\} \mid \mathcal{F}\right]\label{eq:ETIdef}
\end{align}
giving the expected value of the size of the random set of the zero crossings of $df$ on $\mathcal{I}$ conditional on a suitable filtration.
