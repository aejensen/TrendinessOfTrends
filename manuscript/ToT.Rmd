...
\begin{align}
  f \mid m, \theta &\sim \mathcal{GP}(m, C_\theta(\cdot,\cdot))\label{eq:generatingProcess}\\
...
\begin{proposition}
The Trend Direction Index defined formally in Equation (\ref{eq:TCIdef}) can then be written as
\begin{align}
