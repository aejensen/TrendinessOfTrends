...
\caption{The proportion of daily or occational smokers in Denmark during the last 20 years estimated from survey data and reported by the Danish Health Authority.}
...
\begin{align*}
  \widehat{\Theta}_{-i}^\mathcal{M} = \argsup_{\Theta} N\left(\mathbf{Y}_{-i}; \mu_\beta^\mathcal{M}(\mathbf{t}_{-i}), C_\theta^\mathcal{M}(\mathbf{t}_{-i}, \mathbf{t}_{-i}) + \sigma^2 I\right)
\end{align*}
...
\begin{figure}[htb]
\center\includegraphics{../figures/gpFit}
\caption{hejhej}
\label{fig:smoking1}
\end{figure}

\begin{figure}[htb]
\center\includegraphics{../figures/gpFit_ETI}
\caption{hejhej}
\label{fig:ETI}
\end{figure}
