...
\begin{enumerate}
  ...
  \item[A2:]{$\E[f(t) \mid \beta, \theta] = \mu_{\beta}(t)$ is a twice continiously differentiable function.}
  ...
  \item[A5:]{$f \mid \beta, \theta$ has almost surely continuous second-order sample derivatives. This can be imposed by assuming that ...}  
\end{enumerate}
