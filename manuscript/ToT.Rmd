...
\end{align*}
where $g$ is a known, monotone function. Commonly used transformations for proportions are the isometric log ratio or the arcsine-square-root or logit functions. Our model could directly be fitted to the transformed outcomes, but the posterior estimates will also be on the transformed scale and may therefore be difficult to interpret.
