...
\begin{align*}
  ...
  &+ \geq P(\# \{t \in \mathcal{I} : df(t) = 0\} = 1)
  &+ \geq P(\# \{t \in \mathcal{I} : df(t) = 0\} = 2) + \cdots \\
  &= P(\# \{t \in \mathcal{I} : df(t) \geq 0\} \geq 1)
\end{align*}

Thus, the Expected Trend Instability over $\mathcal{I}$ is an upper bound for the probability of observing at least on zero-crossing event, $df() = 0$ 
