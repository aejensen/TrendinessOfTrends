...
# Trace plot for hyper-parameters for smoking application
\includegraphics{../figures/smoking_traceplot.pdf}

# Trend analysis of smoking data with logit transformed outcome
\includegraphics{../figures/smoking_gpFixed_logit.pdf}
