...
set.seed(12345)
sim25_5 <- mclapply(1:R, function(r) {
  cat("Simulation", r, "\n")
  doSim(25, 0.2)
}, mc.cores = 64)

save(sim25_1, sim25_2, sim25_3, sim25_4, sim25_5,
...
set.seed(12345)
sim50_5 <- mclapply(1:R, function(r) {
  cat("Simulation", r, "\n")
  doSim(50, 0.2)
}, mc.cores = 64)

save(sim50_1, sim50_2, sim50_3, sim50_4, sim50_5,
...
set.seed(12345)
sim100_5 <- mclapply(1:R, function(r) {
  cat("Simulation", r, "\n")
  doSim(100, 0.2)
}, mc.cores = 64)

save(sim100_1, sim100_2, sim100_3, sim100_4, sim100_5,
